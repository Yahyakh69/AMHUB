...
export const DeviceList: React.FC<DeviceListProps> = ({ devices, isLoading, onRefresh, className = '' }) => {
  ...
  const renderDeviceRow = (device: Device) => (
    <div key={device.device_sn} className="pl-4 pr-2 py-2 border-b border-slate-800/50 hover:bg-slate-800/50 transition-colors group cursor-pointer">
